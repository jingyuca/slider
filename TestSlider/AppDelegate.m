...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.side = [[SiderViewController alloc]initWithLeftViewController:na2 CenterViewController:na RigthViewController:na3];
    self.side.leftWidth = 0.8 * [UIScreen mainScreen].bounds.size.width;
    self.side.rightWidth = [UIScreen mainScreen].bounds.size.width;
    self.window.rootViewController = self.side;
